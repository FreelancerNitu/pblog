...
if(isset($_GET['deactive'])){
  ...
  $deactive = $pt->deactivePost($deactiveId);
}
/*******************************
 * Post Delete
 ***************************/ 
              ...
              <table id="datatable" class="table table-bordered dt-responsive nowrap"
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $row['title']?></td>
                    <td><?= $row['catName']?></td>
                    <td><img style="width:50px; height:50px" src=" <?=$row['imageOne']?>"></td>
                    <td><img style="width:50px; height:50px" src=" <?=$row['imageTwo']?>"></td>
                    <td>
                      <?php
                      if($row['postType'] == 1){
                        echo 'Post';
                    ...
                    <td>
                      ...
                      <a href="?delpost=<?=$row['postId']?>" onclick="return confirm('Are You Sure To Delete')"
