        ...
        <div class="row mb-5 mt-5">
          <div class="col-md-12">
            ...
            <?php
             ...
             $offset = ($page - 1 )* $limit;
            $catPort = $port->categoryPort($catId, $offset, $limit);
             if($catPort){
               while($row = mysqli_fetch_assoc($catPort)){
                 ?>
            <!-- Category by post -->
            <div class="post-entry-horzontal">
              <a href="port-single.php?singleId=<?=base64_encode($row['postId'])?>">
                <div class="image element-animate" data-animate-effect="fadeIn"
                  style="background-image: url(admin/<?=$row['pimageOne']?>);">
                </div>
                <span class="text">
                  <div class="post-meta">
            ...
            <?php } }else{
              echo "<h1 class='text-danger m-2'>This Category Has No Portfolio</h1>";
            } ?>
